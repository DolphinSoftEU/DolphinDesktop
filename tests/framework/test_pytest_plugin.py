...
class TestBasicHooksAndOptions:
        ...
        [
            ...
            (
                SimpleNamespace(
                    ...
                    _dolphin_exception_type=AssertionError,
                ),
                False,
            ),
            (
                SimpleNamespace(
                    ...
                    _dolphin_exception_type=ElementNotFoundError,
                ),
                True,
            ),
            (
                SimpleNamespace(
                    ...
                    _dolphin_exception_type=WaitTimeoutError,
                ),
                True,
            ),
        ],
    ...
    def test_report_hook_records_the_real_exception_type(self, monkeypatch):
        monkeypatch.setattr(plugin, "_collect_artifacts", lambda *_args: None)
        item = _Item(Path("."))
        call = SimpleNamespace(when="call", excinfo=SimpleNamespace(type=ElementNotFoundError))
        ...
        assert getattr(report, plugin._EXCEPTION_TYPE_ATTR) is ElementNotFoundError
